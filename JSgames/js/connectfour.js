    ...
    for(var i = 0; i < squares.length; i++)
        (function(index){
            //Adding click to each squares in the grid
    ...
    function checkBoard(){
        const winningArrays = [
            ...
            for(let y = 0; y < winningArrays.length; y++){
                ...
                if(square1.classList.contains('player-1') && square2.classList.contains('player-1')&&square3.classList.contains('player-1')&&square4.classList.contains('player-1')){
                    //If they do player one is winner
                ...
                else if(square1.classList.contains('player-2')&&square2.classList.contains('player-2')&&square3.classList.contains('player-2')&&square4.classList.contains('player-2')) {
    ...
    //Add an event listner to each square that will triggere the checkbox function on Click
